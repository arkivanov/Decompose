...
internal actual class SavedStateHolder actual constructor(
    @Serializable(SavedStateSerializer::class) actual val savedState: SavedState?,
)


internal actual object SavedStateHolderSerializer : KSerializer<SavedStateHolder> by SavedStateHolder.serializer()

private object SavedStateSerializer : KSerializer<SavedState> {

    private val byteArraySerializer = ByteArraySerializer()
    override val descriptor: SerialDescriptor by byteArraySerializer::descriptor
