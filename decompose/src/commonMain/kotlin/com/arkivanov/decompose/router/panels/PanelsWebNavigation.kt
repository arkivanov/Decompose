 ...
 * navigation history.
 * @param mainSerializer a [KSerializer] of the `main` configuration [MC].
 * @param detailsSerializer a [KSerializer] of the `details` configuration [DC].
 * @param extraSerializer a [KSerializer] of the `extra` configuration [EC].
