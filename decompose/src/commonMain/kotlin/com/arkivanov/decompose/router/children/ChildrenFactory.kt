 ...
 *
 * Duplicate (by equality) configurations ([ChildNavState.configuration]) within a [NavState] are supported,
 * but can be disabled by setting [com.arkivanov.decompose.DecomposeParameters.duplicateConfigurationsEnabled]
 * flag to `false`.
 *
