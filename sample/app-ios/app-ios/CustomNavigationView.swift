...
private typealias Children = CustomNavigationComponentChildren<AnyObject, KittenComponent>
...
private struct ChildItems: View {
    private let children: Children

    init(_ children: Children) {
...
private struct KittenModifier: ViewModifier {
